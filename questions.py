...
QUESTIONS = [
    # {"question": "...", "expects": "..."},
    {
        "question": "How much does it cost to climb the tower of the parish church in Kestrelford?",
        "expects": "£2",
    },
    {
    ...
    {
        "question": "How much cheaper is eating on Corry Lane than on the riverside strip in Brightwater?",
        "expects": "third",
    },
    {
        "question": "Where can I buy bread and cheese in Corry Vale?",
        "expects": "farm shop",
    },
    {
        "question": "Which town in the region is easiest to get around for someone with limited mobility?",
